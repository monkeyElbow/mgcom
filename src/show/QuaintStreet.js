...
export default function QuaintStreet() {
  document.title = "Melissa Gerhold - Quaint Street";
...
<Image fluid src={require('../show/img/10QuaintStreet900.jpg')} />
            
            </Col>
            <Col  md={6}>
    <p className='fw-bold fs-1'>Quaint Street</p>
...
<h2>$175</h2>
    ...
    <input type="hidden" name="item_name" value="Quaint - PLACES SHOW 2022" />
