...
export default function HallstattAustria() {
  document.title = "Melissa Gerhold - Hallstatt Austria";
...
<Image fluid src={require('../show/img/7HallstattAustria900.jpg')} />
            
            </Col>
            <Col  md={6}>
    <p className='fw-bold fs-1'>Hallstatt, Austria</p>
...
<h2>$175</h2>
    ...
    <input type="hidden" name="item_name" value="Hallstatt Austria - PLACES SHOW 2022" />
