...
export default function EiffelTowerInFall() {
  document.title = "Melissa Gerhold - Eiffel Tower in Fall";
...
<Image fluid src={require('../show/img/9Eiffel900.jpg')} />
            
            </Col>
            <Col  md={6}>
    <p className='fw-bold fs-1'>Eiffel Tower in Fall</p>
...
<h2>$175</h2>
    ...
    <input type="hidden" name="item_name" value="Eiffel Tower in Fall - PLACES SHOW 2022" />
