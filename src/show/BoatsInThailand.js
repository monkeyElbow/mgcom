...
export default function BoatsInThailand() {
  document.title = "Melissa Gerhold - Boats in Thailand";
...
<Image fluid src={require('../show/img/8BoatsInThailand900.jpg')} />
            
            </Col>
            <Col  md={6}>
    <p className='fw-bold fs-1'>Boats in Thailand</p>
...
<h2>$175</h2>
    ...
    <input type="hidden" name="item_name" value="Boats in Thailand - PLACES SHOW 2022" />
