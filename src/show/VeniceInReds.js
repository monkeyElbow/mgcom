...
export default function VeniceInReds() {
  document.title = "Melissa Gerhold - Venice in Reds";
...
<Image fluid src={require('../show/img/12VeniceInReds900.jpg')} />
            
            </Col>
            <Col  md={6}>
    <p className='fw-bold fs-1'>Venice in Reds</p>
...
<h2>$175</h2>
    ...
    <input type="hidden" name="item_name" value="Venice in Reds - PLACES SHOW 2022" />
