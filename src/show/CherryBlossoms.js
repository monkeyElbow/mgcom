...
export default function CherryBlossoms() {
  document.title = "Melissa Gerhold - Cherry Blossoms";
...
<Image fluid src={require('../show/img/13CherryBlossoms900.jpg')} />
            
            </Col>
            <Col md={6}>
    <p className='fw-bold fs-1'>Cherry Blossoms</p>
...
<h2>$175</h2>
    ...
    <input type="hidden" name="item_name" value="Cherry Blossoms - PLACES SHOW 2022" />
