...
export default function ItalianAlleyway() {
  document.title = "Melissa Gerhold - Italian Alleyway";
...
<Image fluid src={require('../show/img/4ItalianAlleyway900.jpg')} />
            
            </Col>
            <Col  md={6}>
    <p className='fw-bold fs-1'>Italian Alleyway</p>
...
<h2>$175</h2>
    ...
    <input type="hidden" name="item_name" value="Italian Alleyway - PLACES SHOW 2022" />
