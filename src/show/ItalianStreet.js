...
export default function ItalianStreet() {
  document.title = "Melissa Gerhold - Italian Street";
...
<Image fluid src={require('../show/img/11ItalianStreet900.jpg')} />
            
            </Col>
            <Col  md={6}>
    <p className='fw-bold fs-1'>Italian Street</p>
...
<h2>$175</h2>
    ...
    <input type="hidden" name="item_name" value="Italian Street - PLACES SHOW 2022" />
