...
export default function Tangier() {
  document.title = "Melissa Gerhold - Tangier";
...
<Image fluid src={require('../show/img/14Tangier900.jpg')} />
            
            </Col>
            <Col  md={6}>
    <p className='fw-bold fs-1'>Tangier, Morocco</p>
...
<h2>$175</h2>
    ...
    <input type="hidden" name="item_name" value="Tangier - PLACES SHOW 2022" />
