...
export default function Tonnara() {
  document.title = "Melissa Gerhold - Tonnara di Scopello";
...
<Image fluid src={require('../show/img/3Tonnara900.jpg')} />
            </Col>
            <Col md={6}>
    <p className='fw-bold fs-1'>Tonnara di Scopello, Italy</p>
...
<p className='fs-1 fw-bold'>SOLD</p>
    ...
    <input type="hidden" name="item_name" value="Tonnara - PLACES SHOW 2022" />
